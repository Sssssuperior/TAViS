...
def build_sam2_video_predictor(
    ...
    **kwargs,
    ...
    # audio_path = "/root/code/Baseline_adaptor_prompt/assets/vggish-10086976.pth"
    # audio_checkpoint = torch.load(audio_path)
    adjusted_checkpoint = {}
    # for k, v in audio_checkpoint.items():
    #     new_key = "audio_encoder.audio_backbone." + k  
    #     adjusted_checkpoint[new_key] = v
    # ominbind_path = ""
    # ominbind_checkpoint = torch.load(ominbind_path)
    # for k, v in ominbind_checkpoint.items():
    #     new_key = k  
    #     adjusted_checkpoint[new_key] = v
